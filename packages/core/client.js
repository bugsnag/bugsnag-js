...
// const FeatureFlagDelegate = require('./lib/feature-flag-delegate').FeatureFlagDelegate
...
class Client {
  ...
  _configure (opts, internalPlugins) {
    ...
    this._features.mergeFrom(new FeatureFlagDelegate(config.featureFlags))
  ...
  _notify (event, onError, postReportCallback = noop) {
    ...
    event._features.mergeFrom(this._features)
