...
describe('plugin: electron client sync', () => {
  ...
  it('updates feature flags', () => {
    ...
    expect(client._features.flags).toStrictEqual([{ featureFlag: 'a', variant: 'b' }, { featureFlag: 'c' }, { featureFlag: 'd', variant: 'e' }])
  ...
  it('clears a single feature flag', () => {
    ...
    expect(client._features.toJSON()).toStrictEqual([{ featureFlag: 'a', variant: 'b' }, { featureFlag: 'c' }])
