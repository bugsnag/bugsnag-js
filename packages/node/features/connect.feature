...
Scenario Outline: a synchronous thrown error in a route
  ...
  Then I open the URL "http://connect:4318/sync"
...
#   And I start the service "connect"
#   And I wait for the app to respond on port "4318"
#   Then I open the URL "http://192.168.3.52:4318/async"
#   And I wait for 2 seconds
#   Then I should receive a request
#   And the request used the Node notifier
#   And the request used payload v4 headers
...
#   And I start the service "connect"
#   And I wait for the app to respond on port "4318"
#   Then I open the URL "http://192.168.3.52:4318/next"
#   And I wait for 2 seconds
#   Then I should receive a request
#   And the request used the Node notifier
#   And the request used payload v4 headers
...
#   And I start the service "connect"
#   And I wait for the app to respond on port "4318"
#   Then I open the URL "http://192.168.3.52:4318/rejection-sync"
#   And I wait for 2 seconds
#   Then I should receive a request
#   And the request used the Node notifier
#   And the request used payload v4 headers
...
#   And I start the service "connect"
#   And I wait for the app to respond on port "4318"
#   Then I open the URL "http://192.168.3.52:4318/rejection-async"
#   And I wait for 2 seconds
#   Then I should receive a request
#   And the request used the Node notifier
#   And the request used payload v4 headers
...
#   And I start the service "connect"
#   And I wait for the app to respond on port "4318"
#   Then I open the URL "http://192.168.3.52:4318/string-as-error"
#   And I wait for 2 seconds
#   Then I should receive a request
#   And the request used the Node notifier
#   And the request used payload v4 headers
...
#   And I start the service "connect"
#   And I wait for the app to respond on port "4318"
#   Then I open the URL "http://192.168.3.52:4318/throw-non-error"
#   And I wait for 2 seconds
#   Then I should receive a request
#   And the request used the Node notifier
#   And the request used payload v4 headers
