/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 03da6d17538081322b523503fe883156)
// Runtime types generated with workerd@1.20251210.0 2025-12-16 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./scenarios/index");
	}
	interface Env {
		BUGSNAG_API_KEY: "placeholder-api-key";
		BUGSNAG_NOTIFY_ENDPOINT: "placeholder-notify-endpoint";
		BUGSNAG_SESSIONS_ENDPOINT: "placeholder-sessions-endpoint";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUGSNAG_API_KEY" | "BUGSNAG_NOTIFY_ENDPOINT" | "BUGSNAG_SESSIONS_ENDPOINT">> {}
}
