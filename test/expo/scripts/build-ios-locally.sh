...
node_modules/.bin/turtle build:ios -c test/expo/features/fixtures/test-app/app.json --team-id $APPLE_TEAM_ID --dist-p12-path $EXPO_P12_PATH --provisioning-profile-path $EXPO_PROVISIONING_PROFILE_PATH -o build/output.ipa
