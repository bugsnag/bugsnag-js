...
class BugsnagTestInterfaceImpl {
  ...
  static final String MODULE_NAME = "BugsnagTestInterface";

  private final ReactApplicationContext reactContext;

  private ScenarioFactory factory = new ScenarioFactory();

  public BugsnagTestInterfaceImpl(ReactApplicationContext reactContext) {
  ...
  public void runScenarioSync(String scenarioName) {
    Scenario testScenario = factory.testScenarioForName(scenarioName, reactContext);
    testScenario.runSync();
  }
