...
// make sure we install compatible versions of peer dependencies
const reactNativeFileAccessVersion = '3.1.1'
...
if (!process.env.SKIP_GENERATE_FIXTURE) {
  ...
  // Configure React Navigation for both old and new architecture
