...
declare module 'xcode' {
    export class Project {
        ...
        addBuildPhase(filePathsArray: string[], buildPhaseType: string, comment: string, target: string | null, optionsOrFolderType: Record<string, string>, subfolderPath?: string): {
            uuid: string;
            buildPhase: {};
        };
        writeSync(): string;
        hash: {
            project: {
                objects: {
                    PBXShellScriptBuildPhase: Record<string, Record<string, unknown>>;
                };
            };
        };
        filepath: string;
